...
/**
 * Additional test class for {@link PetController} covering edge cases.
 */
...
class PetControllerAdditionalTests {
	...
	void setup() {
		...
		dog.setBirthDate(LocalDate.of(2019, 5, 1));
	...
	@Test
	void testFindPetForExistingOwnerAndPet() throws Exception {
